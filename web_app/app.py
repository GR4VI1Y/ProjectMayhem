...
if df is not None:
    ...
    st.markdown(f'<h3 style="margin-top: 0.7rem; margin-bottom: 0.35rem;">{get_text(language, "selected_period_sales")}</h3>', unsafe_allow_html=True)
    ...
    st.markdown(f'<h3 style="margin-top: 0.7rem; margin-bottom: 0.35rem;">{get_text(language, "all_period_sales")}</h3>', unsafe_allow_html=True)
